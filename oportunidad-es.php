...
<head>
    ...
    <!-- Title -->
    <title>Trabaja con nosotros | B&C Corporation</title>
                ...
                <div class="row h-100 align-items-center">
                    ...
                    <div class="col-12 col-sm-7">
                        <div class="top-social-area" align="left">
                            <a style="font-size: 18px" href="oportunidad.php">EN</a>|<a style="font-size: 18px" href="#">ES</a>
                        </div>
                    </div>
                </div>
            </div>
